...
const PROJECTS = [
  ...
  { id: "07Alley",             label: "Alley",             category: "Prop",  ratio: 1,       desc: "<strong>구조물이 밀집된 도심의 좁은 골목</strong>을 콘셉트로 제작한 환경 작업입니다.\n배관과 간판, 생활 소품을 공간 곳곳에 배치해 <strong>복잡한 골목의 밀도와 생활감</strong>이 자연스럽게 느껴지도록 구성했습니다.",        date: "2025.10", period: "2025.09 – 2025.10", role: "Modeling / Lighting",      scope: "Personal", focus: "Mood & Lighting",   pipeline: "3ds Max · ZBrush · Substance Painter · Unreal Engine 5" },
  ...
  { id: "03Zbrush",            label: "Zbrush",            category: "Sculpt",       ratio: 1,       desc: "<strong>자연 암석의 불규칙한 형태와 거친 표면</strong>을 중심으로 제작한 ZBrush 스컬프팅 작업입니다.\n<strong>큰 암석 덩어리와 실루엣</strong>을 먼저 구성한 뒤 크기가 다른 파손면과 작은 암석을 더해 자연스러운 구조와 깊이감을 표현했습니다.",          date: "2025.05", period: "2025.05 – 진행중",   role: "Sculpting",                scope: "Personal", focus: "Organic Form",      pipeline: "3ds Max · ZBrush · Substance Painter · Unreal Engine 5" },
];
