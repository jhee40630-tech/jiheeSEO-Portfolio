/* =========================================================
   ...
   ========================================================= */
const PROJECTS = [
  { id: "10Desert",           label: "Desert",           category: "Environment",  ratio: 16 / 9,  desc: "<strong>사막 한가운데 자리한 판타지 신전</strong>을 콘셉트로 제작한 환경 작업입니다. 직접 제작한 <strong>반복형 건축 모듈을 중심으로 자체 제작 에셋과 일부 활용 에셋</strong>을 조합해 주요 신전 공간을 구성했습니다. Meshy AI는 <strong>초기 블록아웃 단계에서 규모와 배치를 검토하는 용도</strong>와 <strong>후면 배경의 대형 신전 제작</strong>에 한정해 활용했습니다.",           date: "2026.08", period: "2026.04 – 2026.08", role: "Environment / Lighting",  scope: "Personal", focus: "Atmosphere",       pipeline: "3ds Max · ZBrush · Substance Painter · Unreal Engine 5" },
