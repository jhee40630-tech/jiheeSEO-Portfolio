/* =========================================================
   ...
   ========================================================= */
const PROJECTS = [
  { id: "10Desert",           label: "Desert",           category: "Environment",  ratio: 16 / 9,  desc: "<strong>사막 한가운데 자리한 판타지 신전</strong>을 콘셉트로 제작한 환경 작업입니다. <strong>반복 가능한 건축 모듈과 주변 에셋</strong>을 조합해 넓은 신전 공간을 구성했으며, 초기 공간 배치 검토와 후면의 대형 건축물 2종에는 Meshy AI를 활용했습니다.",           date: "2026.08", period: "2026.04 – 2026.08", role: "Environment / Lighting",  scope: "Personal", focus: "Atmosphere",       pipeline: "3ds Max · ZBrush · Substance Painter · Unreal Engine 5" },
