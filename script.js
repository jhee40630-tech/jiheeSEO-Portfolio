/* =========================================================
   ...
   ========================================================= */
const PROJECTS = [
  { id: "10Desert",           label: "Desert",           category: "Environment",  ratio: 16 / 9,  desc: "사막 한가운데 자리한 판타지 신전을 콘셉트로 제작한 환경 작업입니다. <strong>중앙 신전과 원형 광장, 주변 유적을 연결해</strong> 전체 공간을 구성했습니다. Meshy AI는 <strong>초기 블록아웃의 규모·배치 검토와 후면 배경 신전 제작에만 활용</strong>했습니다.",           date: "2026.08", period: "2026.04 – 2026.08", role: "Environment / Lighting",  scope: "Personal", focus: "Atmosphere",       pipeline: "3ds Max · ZBrush · Substance Painter · Unreal Engine 5 · Meshy AI" },
